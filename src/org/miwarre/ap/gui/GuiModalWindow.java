...
public class GuiModalWindow extends GuiPanel implements Listener
{
	 ...
	 * @param	typeParam	a parameter depending on the group type; for GROUPTYPE_SCROLLLIST is the max
	 ...
	 * 						setCallback() method.
	 */
	public GuiModalWindow(Plugin plugin, String title, int groupType, int typeParam, GuiCallback callback)
	{
		...
		case GuiDefs.GROUPTYPE_SCROLLLIST:
			_panel	= new GuiScrollList(typeParam, false);
			break;
		default:
			_panel	= null;
			break;
